...
import (
	...
	"github.com/peace0phmind/bud/lib/netutil"
	"github.com/peace0phmind/bud/lib/upgrade"
)
...
func migrateToConfigV14(cfg *Configuration) {
	...
	if cfg.Options.ReleasesURL == "https://api.github.com/repos/peace0phmind/bud/releases?per_page=30" {
